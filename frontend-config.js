...
const isBackendHostedPage = isLocalScamCheck && ['5000', '8766'].includes(window.location.port);
window.SCAMCHECK_CONFIG = Object.freeze({
    API_BASE_URL: isLocalScamCheck
        ? (isBackendHostedPage ? window.location.origin : 'http://127.0.0.1:5000')
